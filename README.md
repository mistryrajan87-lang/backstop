...
From the run of **Sat, 19 Sep 2026 20:12:42 GMT** — 107 calls, 73 credits. Every figure below is that one run, archived at
[`2026-09-19T20-12-42Z.json`](docs/data/snapshots/2026-09-19T20-12-42Z.json), and rewritten here by
...
| HHI over issuers, by value | **2,329.2** — 4.29 effective issuers |
